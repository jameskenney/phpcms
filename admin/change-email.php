...
?>
	...
	<form class="signup-form-container" role="form" method="post"
		...
		<div class="form-header">
			<h3><span class="login-title"> Change Email Address</span>
		...
		<div class="form-body">
			...
			<div class="form-group">
				<div class="input-group input-group-relative">
					...
					<input name="uname_email" type="text" id="name" class="form-control" placeholder="New Email Address"
					       maxlength="40"
					       autofocus="true">
				</div>
				<span class="help-block" id="check-e"></span>
			...
			<div class="form-group">
				<div class="input-group">
					<div class="input-group-addon"><img src="../assets/fonts/solid/envelope.svg" class="user"></div>
					<input name="uname_email" type="text" id="name" class="form-control" placeholder= "Confirm Email Address">
				</div>
			...
			<div class="row">
				<div class="form-group  left-col col-lg-6">
					<button type="submit" name="btn-register" class="btn btn-info" id="btn-signup">
						<img src="../assets/fonts/solid/sign-in.svg" class="sign-in"> &nbsp; Change Email Address
					</button>
				</div>
